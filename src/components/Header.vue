<template>
  ...
  <div id="header" class="container-fuild">
    ...
    <div class="header-top container-fuild hidden-xs">
      <div class="container">
        <div class="server pull-left" v-for="(item,index) in myList" :key="index">
          <span class="glyphicon glyphicon-earphone"></span>{{item.mobile}}
...
export default {
  ...
  methods: {
    ...
    handleLogin: function () {
      let _this = this
      let url = config.ROOT_API_URL + "/web/contact_list/";
      this.$axios
        .get(url)
        .then(function (res) {
          _this.myList =  res.data.data.list
        })
